# MangoPi M28C Immortalwrt 自动构建

[![Build and Release](https://github.com/zzzz0317/immortalwrt-m28c-auto-build/actions/workflows/build.yml/badge.svg)](https://github.com/zzzz0317/immortalwrt-m28c-auto-build/actions/workflows/build.yml)

删除了大部分无用的软件包，修改了主题

## 已知问题

1. 目前必须叠加额外的 IPv6 修复 hotplug 脚本才可以让下游设备使用 IPv6 功能。直接原因为系统路由表内包含了 unreachable 路由，根本原因有待排查。
